...
class EventImagesControllerTest < ActionController::TestCase
  ...
  test "should create event_image" do
    assert_difference('EventImage.count') do
      post :create, event_image: { alt_text: @event_image.alt_text, description: @event_image.description, event_image: @event_image.event_image }
    end
  ...
  test "should update event_image" do
    patch :update, id: @event_image, event_image: { alt_text: @event_image.alt_text, description: @event_image.description, event_image: @event_image.event_image }
    assert_redirected_to event_image_path(assigns(:event_image))
  end
